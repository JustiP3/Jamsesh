...
justin = User.create(name: 'Justin', username: 'JP', instrument: "guitar", location: "Oakland", password: "asdf", commitment: 2)
jakethedog = User.create(name: 'Jake the Dog', username: 'Jake', instrument: "drums", location: "Adventure Kingdom", password: "asdf", commitment: 2)
...
greg = new_buddas.users.create(name: "Greg", bio: "check out my soundcloud", username: "gdawg", instrument: "vocals", password: "asdf", commitment: 3, location: "seattle")
